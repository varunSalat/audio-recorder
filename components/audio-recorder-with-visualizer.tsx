  ...
  useEffect(() => {
    ...
    const visualizeVolume = () => {
      ...
      const draw = () => {
        ...
        switch (variant) {
          case "line":
            drawLine(dataArray, canvasCtx, HEIGHT, WIDTH);
            break;
          case "circle":
            drawCircle(dataArray, canvasCtx, HEIGHT, WIDTH);
            break;
          case "wave":
            drawWaveLine(dataArray, canvasCtx, HEIGHT, WIDTH);
            break;
          case "verticalBars":
            drawVerticalBars(dataArray, canvasCtx, HEIGHT, WIDTH);
            break;
          case "radial":
            drawRadialLines(dataArray, canvasCtx, HEIGHT, WIDTH);
            break;
          case "dots":
            drawCircularDots(dataArray, canvasCtx, HEIGHT, WIDTH);
            break;
          case "pulse":
            drawPulseCircle(dataArray, canvasCtx, HEIGHT, WIDTH);
            break;
          default:
            // existing bars logic
            canvasCtx.clearRect(0, 0, WIDTH, HEIGHT);
